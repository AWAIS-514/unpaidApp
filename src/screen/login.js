...
<View style={styles.passwordContainer}>
  <Icon name="account" color='#000' size={30}  />
  <TextInput
...
<View style={{width:'60%',display:'flex',flexDirection:'row',alignItems:'center',justifyContent:'space-around'}}>
<TouchableOpacity><Text style={{color:'#000',fontSize:10,marginTop:5}}>Click Here</Text></TouchableOpacity>



<TouchableOpacity><Text style={{color:'#000',fontSize:10,marginTop:5}}>Merchant Login</Text></TouchableOpacity>
