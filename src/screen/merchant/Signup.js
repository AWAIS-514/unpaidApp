...
function MerchanrtSignup(Props) {
...
<View style={styles.passwordContainer}>
  <Icon name="domain" color='rgba(80, 78, 78, 0.61)' size={25}  />
  <TextInput
    style={styles.inputStyle}
      autoCorrect={false}
...
<View style={styles.passwordContainer}>
  ...
  <TextInput
    style={styles.inputStyle}
      autoCorrect={false}
      placeholder="Brand Representative Number"
      // value={this.state.password}
      // onChangeText={this.onPasswordEntry}
    />
...
const styles = StyleSheet.create({
  ...
  const mapDispatchToProps = dispatch => {
    ...
    export default connect(mapStateToProps,mapDispatchToProps)(MerchanrtSignup)